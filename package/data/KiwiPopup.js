  ...
  sendParcel = function(parcel) {
    ...
    switch (parcel.msg) {
      case 'kiwiPP_acknowledgeMessage':
        return self.port.emit('kiwiPP_acknowledgeMessage', parcel);
