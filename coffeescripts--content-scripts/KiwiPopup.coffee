...
$().ready( ->
  ...
  # self.port.emit('click-link', "'a");
  # self.port.emit('click-link', "'a" + $('body').length);
    ...
    __renderStates__: =>
      collapsed: 
        paint: (popupParcel) =>
          ...
          # console.log 'popup::console.log @DOMselector + " .topSearchBar"' + @DOMselector + " .topSearchBar"
      ...
      opened: 
        ...
        bind: (popupParcel) =>
          ...
          customSearchQuerySubmit.bind 'click', =>
            # console.log "customSearchQuerySubmit.bind 'click', =>"
            sendSearch()
  ...
  class Credits extends SwitchView
    ...
    __renderStates__: =>
      __normal__: 
        ...
        bind: (popupParcel) =>
          # console.log 'popup::binding ' + @name
  ...
  receiveParcel  = (parcel) ->
    ...
    switch parcel.msg
      ...
      when 'kiwiPP_popupParcel_ready' 
        ...
        #     else 
        #       console.log 'popup::chrome-devtools:// '
        #       return 0  
  ...
  # console.log 'popup::trying to send123 in front '
)
# $().ready(
