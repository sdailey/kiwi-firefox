...
Panel = require("sdk/panel").Panel # { Panel } sets Panel equal to the .Panel attribute 

{ ToggleButton } = require("sdk/ui/button/toggle")

IconButton = require("sdk/ui/button/action").ActionButton

# jQuerySuccess = require("./vendor/export--jquery-2.1.4.min.js").init_jQuery()
...
# _ = require("./vendor/Underscore1-8-3").underscore
# `
...
console.log _.pick({name: 'moe', age: 50, userid: 'moe1'}, 'name')
console.log 'console.log tabs.activeTab'
console.log tabs.activeTab.readyState
console.log tabs.activeTab
# console.debug tabs.activeTab

# latestTweetRequest = Request({
#   url: "",
#   onComplete: (response) ->
...
Request({
  ...
  onComplete: (response) ->
    ...
    #   console.log 'response.json.remaining_hits ' + response.json.remaining_hits
...
#     console.log 'if _.isArray(newsSearch.results)'
...
# myTestCommonJSscript = "window.addEventListener('click', function(event) {
#               var t = event.target;
#               if (t.nodeName == 'A')
...
panel = Panel({
  ...
  contentURL: "./test.html",  # "./test.html"
